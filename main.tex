...
El objetivo de estos experimentos es ajustar los parámetros del Simulated Annealing para conseguir mejores resultados que con Hill Climbing. 

Vamos a hacer el experimento para el mismo escenario que en los experimentos anteriores y utilizando la función heurística, los operadores y la estrategia de generación de la solución inicial escogidos.
