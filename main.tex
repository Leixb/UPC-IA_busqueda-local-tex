...
\end{hyp*} % no sé que más poner xD (yo lo dejaría así) además he puesto exactamente la misma en el de SA, al ser una hipotesis he supuesto que no pasaba nada, pero idk
...
% k hacemos?
% no se me ocurre k poner la veradd
% la conclusion la sacamos? XD
% si yo lo quitarí. con lo de comparación de heuristicas ya vale como conclusión.
% wait, en el 6 se usa SA
% pero no he usado los parametros k dices creo
% he dejado los por defecto lol
% F
% jaja bueno son 5 minutos rehacerlo
% k parametros pongo?
% NO WAY  pues esos, steps = 1000000, stiter = 10000, k = 10000 y lamb = 0.01

% confimamos?  perf, pues le doy % Perf, me leo lo de Moisés
%    STEPS=1000000
%    STITER=10000
%    K=10000
%    LAMB=0.01

% TODO (esto es lo del exeperimento 8),
% k es basicamente la conclusion en verdad
%  lo unico es k no se k poner tbh. pork en los otros puntos ya he puesto la comparacion
% de las huerisicas 
% supongo que es repetir un poco lo k ya se ha dicho y ya. Ni idea

% pues si, no creo que tenga que ser muy extenso

%    Dados los resultados obtenidos con todos estos experimentos, comparad las dos aproximaciones y
% comentad las ventajas y desventajas de cada una. ¿Cual de las dos consideráis que es una mejor solución?
% (comparar tamién los algoritmos)
...
% METELO AQUI vale % no sé si cambiarlo todo transcribiendo sus palabras
...
% Comento todo lo de moisés, no lo borro.
...
%\begin{itemize} wait un segundo k lo hago con vim
%		\item Descripción del producto o servicio: Moisés.
%		\item Descripción de las técnicas de IA que se han utilizado: Moisés.
...
% bueno podemos dejar esto maybe
% sin el PD igual tiene un pase.
% pork sino no queda nada de moises.
%
% ya ves esque se lo hemos quitado todo lol jajaja pero esque esta muy raro estructurada la frase.
% definitivamente no
% sudamos de la conclusión, no? seh... jajaja a ver me miro lo que has pues en comparativa pero tiene pinta que con eso ya vale. OK
% si puedes mete un poco mas en lo de la comparativa pork tampoc me la he currado mucho la verdad.
% es muy cutre.

%Además de forma complementaria íbamos compartiendo toda información que nos pareciese útil para los demás apartados.
% lloremos
...
% asi ok?sigue fluyendo muy rara la frase pero bueno. suda mucho dejalo asi
% ME ESTÁ MATANDO CADA VEZ QUE LA LEO quizás no me aguanto y borro un "informacion" que hay 3 en tres lineas (3/3).
% esk se repite muchisimo. 
% voy a mirarme la paginacion okay
...
El proceso de búsqueda de la información nos ha resultado tedioso, al tener que ir leyendo distintas páginas hasta dar con las páginas que pensamos que nos van a resultar útiles.


% Dificultades que hayáis encontrado a la hora de buscar la información necesaria para el trabajo
% lol
% creo k ha copiado el enunciado y ha escrito encima o algo
% yo esa técnica la uso pero la disimulo un poco (o lo intento)

% yo casi que hubiera hecho una tabla en plan:
%           Aleix   Alex    Moisés
% task1             x
% task2     x
% task2                     x
...
% esque queda muy repetitivo el Se ha encargado X1 de Y1. Se ha encargado X1 de Y2...
...
%HA x2
% en whats lo entiendo, pero en ordenador que tienes mil correctores buenos?? nose...

% y esta última linea? si no la piden yo la quitaría pero me sabe mal por Moisés xD
%JAJAJAJ tediosísimo. ya lol pone que NO van a ser útiles? jajaja
% lmao no puede ser. La primera frase no consigo entenderla. Tiene el vicio de decir "es decir" y no aclarar nada, repite lo mismo con otrsa palabras o dice algo que lia más
% T_T 
% 
