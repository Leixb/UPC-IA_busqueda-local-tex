...
tanto el tiempo total de transmisión como el tiempo de ejecución. Los parámetros usados son
los mismos del experimento 1.
Se ejecutaron 100 repeticiones usando la primera heurística y 100 más usando la segunda. Se
