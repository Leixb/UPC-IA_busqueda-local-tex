...
El problema consiste en un grupo de servidores que forman un sistema de ficheros(estos servidores contienen ficheros que pueden contener otros servidores, por lo que cuando un usuario haga una petición más de un servidor le podrá servir ese fichero pero tardaran tiempos distintos). En este sistema de ficheros hay uno de los servidores que se encarga de distribuir la peticiones realizadas por los usuarios.
